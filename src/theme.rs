...
impl Theme {
    ...
    pub fn from_scheme(scheme: ColorScheme) -> Self {
        ...
        let (sel_bg, legal_bg, lm_light, lm_dark, cursor) = match scheme {
            ColorScheme::Green => (
                Color::Rgb(130, 170, 100),
                Color::Rgb(170, 180, 140),
                Color::Rgb(245, 246, 130),
                Color::Rgb(186, 202, 68),
                Color::Rgb(200, 200, 100),
            ),
            ColorScheme::Amber => (
                Color::Rgb(180, 140, 60),
                Color::Rgb(200, 180, 120),
                Color::Rgb(240, 220, 100),
