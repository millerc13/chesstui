...
mod classic {
    pub const WHITE_KING: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_king_white.png");
    pub const BLACK_KING: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_king_black.png");
    pub const WHITE_QUEEN: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_queen_white.png");
    pub const BLACK_QUEEN: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_queen_black.png");
    pub const WHITE_ROOK: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_rook_white.png");
    pub const BLACK_ROOK: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_rook_black.png");
    pub const WHITE_BISHOP: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_bishop_white.png");
    pub const BLACK_BISHOP: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_bishop_black.png");
    pub const WHITE_KNIGHT: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_knight_white.png");
    pub const BLACK_KNIGHT: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_knight_black.png");
    pub const WHITE_PAWN: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_pawn_white.png");
    pub const BLACK_PAWN: &[u8] =
        include_bytes!("../../assets/pieces/classic/chess_pawn_black.png");
}
